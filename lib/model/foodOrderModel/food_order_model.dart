...
import 'package:uberdriver/model/add_food_model.dart';
import 'package:uberdriver/model/driverModel/driver_model.dart';
import 'package:uberdriver/model/restaurant_model.dart';
import 'package:uberdriver/model/user_address_model.dart';
import 'package:uberdriver/model/user_model.dart';
...
class FoodOrderModel {
  ...
  factory FoodOrderModel.fromMap(Map<String, dynamic> map) {
    return FoodOrderModel(
      ...
      resturantDetails: RestaurantModel.fromMap(
          map['resturantDetails'] as Map<String, dynamic>),
